...
public interface IInviteService
{
    ...
    /// <summary>
    /// The id of the signed-in caller's own invite for a campaign — matched on their verified email
    /// or phone against the guest list — creating it on first view and marking it viewed. Used to hand
    /// a guest over to the server-rendered invitation without rendering it here first. Throws if they
